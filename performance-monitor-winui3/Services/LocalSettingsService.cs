...
using performance_monitor_winui3.Core.Helpers;
...
namespace performance_monitor_winui3.Services;

public class LocalSettingsService : ILocalSettingsService
{
    private const string _defaultApplicationDataFolder = "performance-monitor-winui3/ApplicationData";
